...
from election_dynamics.electoral_systems import create_fptp_multiparty_electorate, create_rcv_electorate, create_simple_electorate
...
def create_us_electorate_multiparty_rcv():
    """
    Creates a multiparty RCV US electorate corresponding to the data from Echelon Insights, populated with Euclidean voters.
    This electorate does not account for the voter weights present in Echelon's data, nor for other attributes in the
    data, outside of the Econ Scores and Social Scores of the voters.
...
def create_us_electorate_echelon_multiparty_fptp():
    """
    Creates a multiparty FPTP US electorate corresponding to the data from Echelon Insights, populated with Euclidean voters.
    This electorate does not account for the voter weights present in Echelon's data, nor for other attributes in the
    data, outside of the Econ Scores and Social Scores of the voters.
    ...
    # defining electorate
    electorate = create_fptp_multiparty_electorate(voters, "Economic Conservatism", "Social Conservatism")
    return electorate
